      ...
      >
        ...
        <div className="bg-white p-12 lg:p-16 border border-stone-200 shadow-xl relative text-center">
          ...
          <button
            ...
            className="w-full group relative flex items-center justify-center gap-3 px-6 py-4 bg-white border border-stone-300 hover:border-stone-900 transition-all duration-300 shadow-sm hover:shadow-md"
          >
            {isSigningIn ? (
